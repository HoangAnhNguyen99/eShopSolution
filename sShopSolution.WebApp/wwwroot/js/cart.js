            ...
            success: function (res) {
                ...
                $.each(res, function (i, item) {
                    ...
                    html += "<tr>"
                        ...
                        + "<button class=\"btn btn-remove btn-danger\" type=\"button\" data-id=\"" + item.productId + "\"><i class=\"icon-remove icon-white\"></i></button>"
                        + "</div>"
                        + "</td>"
                        + "<td>" + numberWithComas(item.price) + "</td>"
                        + "<td>" + numberWithComas(amount) + "</td>"
                        + "</tr>";
                    total += amount;
                });
                $('#cart_body').html(html);
                $('#lbl_number_of_items').text(res.length);
                $('#lbl_total').text(numberWithComas(total));
            }
        })
    }
}